...
//Lista a los usuarios que seguimos
...
//Lista a los usuarios que nos siguen
function getUsuariosMeSiguen(req,res){
	var userId = req.user.sub;
...
function getMyFollows(req,res){
	...
	//Si se recibe la variable followed, se busca a los usuarios que me siguen
